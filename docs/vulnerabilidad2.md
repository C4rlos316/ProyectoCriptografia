...
paser enc.add_argument(
    "--firma--privada",
    default=None,         #<-Sin advertencia emitida al omitirlo
    ...
)
```
# Correción Aplicada

Se añadieron advertencias explícitas en stderr cuando se omiten -firma-provocada o -firma-pública, para que los usuarios siempre estén informados de cuando operan sin autenticación.
