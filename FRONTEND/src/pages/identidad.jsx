  ...
  return (
    <>
      <div className="page-header">
        <h2>Generar identidad RSA</h2>
        <p>Par de llaves RSA-2048 para cifrado híbrido</p>
      </div>
      ...
      <div className="card">
        ...
        <div className="field">
          <label>Contraseña para proteger la llave privada</label>
        ...
        <>
          <div className="result-box">
            <div className="result-box-header">
              <h3>Llave pública</h3>
              <button className="btn btn-ghost" onClick={() => download(resultado.public_key, `${usuario}_public.pem`)}>
                ↓ Descargar .pem
              </button>
            </div>
            <pre>{resultado.public_key}</pre>
          </div>
