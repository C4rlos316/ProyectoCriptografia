...
async def cifrar(
    ...
    firma_keystore: Optional[str] = Form(None),   # contenido JSON del .keystore
    firma_password: Optional[str] = Form(None),
):
    try:
